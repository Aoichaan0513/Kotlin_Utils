...
fun DateTime.getFormattedDateTime(zoneId: ZoneId) =
    DateTimeFormat.mediumDateTime().withZone(DateTimeZone.forID(zoneId.id)).print(this)

fun LocalDate.getFormattedDateTime(zoneId: ZoneId) =
    atStartOfDay(zoneId).getFormattedDateTime()

fun LocalDateTime.getFormattedDateTime(zoneId: ZoneId) =
    atZone(zoneId).getFormattedDateTime()

fun OffsetDateTime.getFormattedDateTime(zoneId: ZoneId) =
    atZoneSameInstant(zoneId).getFormattedDateTime()
